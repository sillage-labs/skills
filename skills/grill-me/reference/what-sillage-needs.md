...
| `headcount`         | string[] | Company-size ranges, e.g. `"1-10"`, `"11-50"`, `"51-200"`, `"201-500"`, `"501-1000"`, `"1001-5000"`, `"5000+"`.                                                   |
...
Required: `name`, `type`. Type is one of `keyword_detection`, `competitor`, `partner`, `customer`,
`influencer`, `champion`.
